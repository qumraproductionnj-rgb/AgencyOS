...
export function ContentPillarsDesigner({ t }: Props) {
  ...
  return (
    <AiToolPanel title="content_pillars_designer" icon="📊">
            ...
            <button
              onClick={() =>
                generate(
                  ...
                  'You are a content strategist. Design 3-5 content pillars for the brand. For each include: pillar name, description, example topics, recommended formats, and target percentage of content mix.',
                )
              }
